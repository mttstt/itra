    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'historical Scenari',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descrizione', models.CharField(max_length=255, verbose_name='Descrizione')),
                ('campagna', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='scenari', to='campagne.campagna')),
            ],
            options={
